...
import ConsumerPCFExchangeHistory from './PcfRequestHistory';
import SearchRequestPCFValue from './SearchAndRequestPCFValue';
...
const RECURRING_UPLOAD_TABS: IUploadTabs[] = [
  { label: 'Request History', component: <ConsumerPCFExchangeHistory /> },
  { label: 'Search and Request for PCF', component: <SearchRequestPCFValue /> },
];

function ConsumerPCFExchange() {
